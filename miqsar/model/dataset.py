...
class MolDataSet(Dataset):
    ...
    def preprocess(self):
        x_train, x_test, y_train, y_test = train_test_split(self.bags, self.labels, test_size=0.25,random_state=45)
        x_train_scaled, x_test_scaled = scale_data(x_train, x_test)
        x_train_scaled, x_val_scaled, y_train, y_val = train_test_split(x_train_scaled, y_train, test_size=0.2,random_state=43)
